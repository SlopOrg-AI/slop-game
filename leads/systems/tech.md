...
- **One commit attributed to "Unidentified surface"** — `proposals/2026-09-20-prior-art-agent-management.md`, written while Tech was in session. Committed rather than left untracked, because uncommitted work dies with the machine; labelled honestly rather than guessed at, because guessing is what went wrong earlier today. The owner says the art agent is identified next pass — when it is, a correction commit names the writer.
